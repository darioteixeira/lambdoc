...
(* OASIS_START *)
(* DO NOT EDIT (digest: 296b1df29065e2796f7da2404977dbf4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_lambtex", []))];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("pxp-engine", None);
                           FindlibPackage ("pxp-ulex-utf8", None);
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Lambdoc_rlambtex";
                           "Lambdoc_rlambtex_globalenv";
                           "Lambdoc_rlambtex_parser";
                           "Lambdoc_rlambtex_scanner";
                           "Lambdoc_rlambtex_tokenizer";
                           "Lambdoc_rlambtex_readable";
                           "Lambdoc_rlambtex_reader";
                           "Lambdoc_rlambwiki";
                           "Lambdoc_rlambwiki_parser";
                           "Lambdoc_rlambwiki_scanner";
                           "Lambdoc_rlambwiki_tokenizer";
                           "Lambdoc_rlambwiki_readable";
                           "Lambdoc_rlambwiki_reader";
                           "Lambdoc_rlambxml";
                           "Lambdoc_rlambxml_dtd";
                           "Lambdoc_rlambxml_parser";
                           "Lambdoc_rlambxml_readable";
                           "Lambdoc_rlambxml_reader";
                           "Lambdoc_rmarkdown";
                           "Lambdoc_rmarkdown_mapper";
                           "Lambdoc_rmarkdown_readable";
                           "Lambdoc_rmarkdown_reader";
                           "Lambdoc_writer";
                           ...
                           "Lambdoc_whtml5";
                           "Lambdoc_whtml5_writable";
                           "Lambdoc_whtml5_writer"
                        ];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/lambcmd";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lambdoc"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "make";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_lambtex.ml"});
               Test
                 ({
                     cs_name = "test_lambtex";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\030aw\231\021\242\252\188\211\bb\183!\030kE";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
