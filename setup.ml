...
(* OASIS_START *)
(* DO NOT EDIT (digest: 838eaf2bb8f08963d5815306b4a2b15c) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_prelude", []))];
          ...
          ("test_fuzzer",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_fuzzer", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          files_ab = ["src/lambcmd/meta.ml.ab"; "tests/meta.ml.ab"];
          sections =
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build command line utility Lambcmd";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build fuzzer";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("blahcaml", None);
                           FindlibPackage ("camlhighlight", None);
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Lambdoc_prelude";
                           "Lambdoc_document";
                           "Lambdoc_document_ambivalent";
                           "Lambdoc_document_blkcat";
                           "Lambdoc_document_feature";
                           "Lambdoc_document_foldmap";
                           "Lambdoc_document_idiosyncrasies";
                           "Lambdoc_document_invalid";
                           "Lambdoc_document_valid";
                           "Lambdoc_reader";
                           "Lambdoc_reader_ast";
                           "Lambdoc_reader_extension";
                           "Lambdoc_reader_compiler";
                           "Lambdoc_reader_maker";
                           "Lambdoc_reader_permission";
                           "Lambdoc_reader_preprocessor";
                           "Lambdoc_reader_readconv";
                           "Lambdoc_reader_style";
                           "Lambdoc_rlambtex";
                           "Lambdoc_rlambtex_context";
                           "Lambdoc_rlambtex_lexer";
                           "Lambdoc_rlambtex_parser";
                           "Lambdoc_rlambtex_tokenizer";
                           "Lambdoc_rlambtex_readable";
                           "Lambdoc_rlambtex_reader";
                           "Lambdoc_rlamblite";
                           "Lambdoc_rlamblite_parser";
                           "Lambdoc_rlamblite_lexer";
                           "Lambdoc_rlamblite_tokenizer";
                           "Lambdoc_rlamblite_readable";
                           "Lambdoc_rlamblite_reader";
                           "Lambdoc_rlambxml";
                           "Lambdoc_rlambxml_readable";
                           "Lambdoc_rlambxml_reader";
                           "Lambdoc_writer";
                           "Lambdoc_writer_emblang";
                           "Lambdoc_writer_explanations";
                           "Lambdoc_writer_maker";
                           "Lambdoc_writer_translations";
                           "Lambdoc_writer_writeconv";
                           "Lambdoc_whtml";
                           "Lambdoc_whtml_writable";
                           "Lambdoc_whtml_writer"
                        ];
                      lib_pack = false;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Lambdoc";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "lambcmd.ml"});
               Executable
                 ({
                     cs_name = "test_prelude";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_prelude.ml"});
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_fuzzer.ml"});
               Executable
                 ({
                     cs_name = "benchmark_parsing";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "benchmark_parsing.ml"
                   });
               Executable
                 ({
                     cs_name = "benchmark_serialization";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "benchmark_serialization.ml"
                   });
               Test
                 ({
                     cs_name = "test_prelude";
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "tests/test_prelude";
                      test_run =
                        [
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "tests/test_parsing";
                      test_run =
                        [
                           (OASISExpr.ENot (OASISExpr.EFlag "tests"), false);
                           (OASISExpr.EFlag "tests", false);
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "tests/test_fuzzer";
                      test_run =
                        [
                           (OASISExpr.ENot (OASISExpr.EFlag "tests"), false);
                           (OASISExpr.EFlag "tests", false);
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\235\b\000\176_\174\149\1381\241\215\170\177bj\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
