...
(* OASIS_START *)
(* DO NOT EDIT (digest: ac5c1bed2cc3214e79995b77f7dfbc8c) *)
(*
...
let setup_t =
  {
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "Lambdoc_core_hilite";
                           "Lambdoc_core_inline";
                           "Lambdoc_core_wrapper";
                           "Lambdoc_core_heading";
                           "Lambdoc_core_bib";
                           "Lambdoc_core_qanda";
                           "Lambdoc_core_tabular";
                           "Lambdoc_core_block";
                           "Lambdoc_core_note";
                           "Lambdoc_core_target";
                           "Lambdoc_core_valid";
                           "Lambdoc_core_blkcat";
                           "Lambdoc_core_error";
                           "Lambdoc_core_invalid";
                           "Lambdoc_core_ambivalent";
                           "Lambdoc_core_feature";
                           "Lambdoc_core_idiosyncrasies";
                           "Lambdoc_core_monadic";
                           "Lambdoc_core_foldmap";
                           "Lambdoc_reader";
                           "Lambdoc_reader_ast";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "~\158F\182]\202\r\144\228\148\192<\023\248u\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
