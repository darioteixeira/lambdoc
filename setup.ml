...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4653bababf76fdde441a1a680a4dbe94) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_lambdoc",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_lambdoc", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_fuzzer",
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_lambdoc.ml"});
               Executable
                 ({
                     cs_name = "test_fuzzer";
                     cs_data = PropList.Data.create ();
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "tests/fuzzer";
                      test_run =
                        [
                           (OASISExpr.ENot (OASISExpr.EFlag "tests"), false);
                           (OASISExpr.EFlag "tests", false);
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "X\242+\190\223\223\202\151\236n=\193\n\136\166\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
