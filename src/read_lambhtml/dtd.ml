...
let lambhtml_dtd =
	...
	let source = Pxp_types.from_string (include_file "/home/dario/projects/lambdoc/trunk/lambdoc/src/read_lambhtml/lambhtml.dtd") in
	...
	let () = Lambdoc_lib.Entity.iter add_entity
	in dtd
