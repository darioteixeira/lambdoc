...
val tabular: Alignment.t -> Tabular.t ->
	([> `Composition ], [> `Embeddable ], [> `Nestable], [> `Tabular_blk ]) t
...
val part: Label.t -> part_order_t -> (_, _) Node.t list ->
	([> `Manuscript ], [> `Non_embeddable ], [> `Non_nestable], [> `Heading_blk ]) t

val section: Label.t -> section_order_t -> section_location_t -> hierarchical_level_t -> (_, _) Node.t list ->
	([> `Manuscript ], [> `Non_embeddable ], [> `Non_nestable], [> `Heading_blk ]) t
...
val title: title_level_t -> (_, _) Node.t list ->
