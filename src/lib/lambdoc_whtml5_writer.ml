...
module Make_writable (Html5: Html5_sigs.T with type 'a Xml.wrap = 'a and type 'a wrap = 'a and type 'a list_wrap = 'a list) =
struct
...
struct
	module Writable = Make_writable (Html5)

	include Maker.Make (Writable) (Ext)
end
