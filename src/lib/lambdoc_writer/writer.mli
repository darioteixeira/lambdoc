...
sig
	...
	val write_valid: ?valid_options:valid_options_t -> Valid.t -> t
	val write_invalid: ?invalid_options:invalid_options_t -> Invalid.t -> t
end
...
sig
	...
	val write_ambivalent: ?valid_options:valid_options_t -> ?invalid_options:invalid_options_t -> Ambivalent.t -> t
end
