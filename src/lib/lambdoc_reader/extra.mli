...
val get_coversize: default:Book.coversize_t -> extra_t -> handle_t -> Book.coversize_t
...
val fetch_coversize: default:Book.coversize_t -> Ast.command_t -> error_t -> handle_t -> Book.coversize_t
