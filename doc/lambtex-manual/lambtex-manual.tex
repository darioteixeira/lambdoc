...
\body
| \mono{[\$}    | Beginning of inline \caps{TeX} mathematics |
| \mono{\$]}    | End of inline \caps{TeX} mathematics |
| \mono{<\$}    | Beginning of inline \caps{MathML} |
| \mono{\$>}    | End of inline \caps{MathML} |
\body
...
should be delimited between the characters '\mono{\[$}' and '\mono{\$]}' if it is written
in \caps{TeX} format, and between characters '\mono{\<$}' and '\mono{\$>}' if written
...
via the \mono{mathtex} and \mono{mathml} environments, respectively.  Furthermore,
...
a document.  For that you need to wrap a \mono{mathtex} or \mono{mathml} environment
inside an \mono{equation} block.  This technique is part of the advanced features of
...
\mono{verbatim}, \mono{source}, \mono{mathtex}, and \mono{mathml}). Moreover, the
...
\item{Equations}
    ...
    These are declared via the environment command \mono{equation},
    and may be used for wrapping \mono{mathtex} and \mono{mathml} blocks.
...
| \mono{mathml}             | \forbidden    | \forbidden    |
| \mono{mathtex}            | \forbidden    | \forbidden    |
